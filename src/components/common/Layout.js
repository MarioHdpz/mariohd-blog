...
const DefaultLayout = ({ data, children, bodyClass, isHome }) => {
    ...
    const linkedInUrl = `https://linkedin.com/in/mariohd/`
                    ...
                    <div className="container">
                        <div className="site-mast">
                            <div className="site-mast-left">
                                <Link to="/">
                                    <img className="site-logo" src="/images/logo.svg" alt={site.title} />
                                </Link>
                            </div>
                        ...
                        <nav className="site-nav">
                            ...
                            <div className="site-nav-right">
                                <Link className="site-nav-button" to="/about-me">Acerca de mí</Link>
                            </div>
                        </nav>
                    </div>
                </header>
                ...
                <footer className="site-foot">
                    <div className="site-foot-nav container">
                        <div className="site-foot-nav-left">
                            ...
                            &nbsp; and rendered with  <a className="site-foot-nav-item" href="https://www.gatsbyjs.org/" target="_blank" rel="noopener noreferrer">Gatsby</a>
                        </div>
